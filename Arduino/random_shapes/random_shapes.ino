...
void loop() {
	...
	// Draw a line
	int lineX = centerX + sin(angle) * scaledSize;
	int lineY = centerY + cos(angle) * scaledSize;
	matrix.drawLine(centerX, centerY, lineX, lineY, hsvToRgb565((hue + 170) % 255, 255, 255));
