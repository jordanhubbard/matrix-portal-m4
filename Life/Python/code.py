...
matrix = rgbmatrix.RGBMatrix(
    width=WIDTH, height=HEIGHT, bit_depth=1,
...
SCALE = 1
b1 = displayio.Bitmap(display.width//SCALE, display.height//SCALE, 1)
b2 = displayio.Bitmap(display.width//SCALE, display.height//SCALE, 1)
